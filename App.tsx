...
import IndividualConsole from './components/IndividualConsole';
  ...
  return (
    <HashRouter>
      <Routes>
        ...
        {/* Consola Principal (Coletiva + Master Timer) */}
        ...
        {/* Nova Consola Individual (Slave Timer) */}
        <Route path="/matches/:id/individual-console" element={
          <PrivateRoute>
             <IndividualConsole />
          </PrivateRoute>
        } />
