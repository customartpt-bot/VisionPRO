...
const CoachDashboard: React.FC = () => {
  ...
  // Filtragem do Event Log conforme solicitado
  const filteredEvents = useMemo(() => {
    return events.filter(ev => {
      // Eventos coletivos (sem player_id) são sempre mostrados
      if (!ev.player_id) return true;
      // Eventos individuais apenas: golos, assistências, substituições, cartões
