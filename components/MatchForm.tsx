      ...
      <div className="max-w-4xl mx-auto bg-dark-surface p-8 rounded-xl border border-dark-border shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="grid grid-cols-2 gap-8">
             <div>
                <label className={labelClass}>Plantel Casa <span className="text-gray-500 normal-case">(1-11 Titulares, resto Suplentes)</span></label>
                <textarea 
             ...
             <div>
                <label className={labelClass}>Plantel Visitante <span className="text-gray-500 normal-case">(1-11 Titulares, resto Suplentes)</span></label>
                <textarea 
                  className={`${inputClass} h-48 font-mono text-xs`}
